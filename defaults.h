...
#define defaults_h
  ...
  #define DEFAULT_RAPID_FEEDRATE 600.0 // mm/min
...
#ifdef DEFAULTS_MTM_SNAP
  // Grbl for the MTM snap mtm.cba.mit.edu
  #define DEFAULT_X_STEPS_PER_MM (400.0 * 10.0 / 25.4)
  #define DEFAULT_Y_STEPS_PER_MM (400.0 * 10.0 / 25.4)
  #define DEFAULT_Z_STEPS_PER_MM (400.0 * 10.0 / 25.4)
  #define DEFAULT_STEP_PULSE_MICROSECONDS 10
  ...
  #define DEFAULT_ACCELERATION (10.0*60*60) // 10 mm/min^2
  #define DEFAULT_JUNCTION_DEVIATION 0.05 // mm
  #define DEFAULT_STEPPING_INVERT_MASK ((0<<X_DIRECTION_BIT)|(0<<Y_DIRECTION_BIT)|(0<<Z_DIRECTION_BIT))
  #define DEFAULT_REPORT_INCHES 0 // false
  #define DEFAULT_AUTO_START 1 // true
  #define DEFAULT_INVERT_ST_ENABLE 0 // false
  #define DEFAULT_HARD_LIMIT_ENABLE 0  // false
